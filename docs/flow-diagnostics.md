...
| Imported diagnostic attribution | Monthly SPI−2 factor0.5, both located regimes and exact input years retained | `test_monthly_attribution_retains_inputs_years_and_spi` |
