"""IARI evaluation orchestrator for taqsim WaterSystem pairs."""
...
def evaluate_iari(
    ...
    *,
    ...
    """Evaluate IARI classification for each shared natural Reach node.
    ...
    Returns:
        Dict mapping reach_id to IARIResult for each successfully evaluated Reach.
    ...
    for rid in selected:
        try:
            ...
            logger.warning("IARI evaluation failed for reach '%s': %s", rid, exc)
            errors[rid] = exc
